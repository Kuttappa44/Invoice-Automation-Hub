...
MATCHING_EXCEL_FILE_PATH = os.getenv('EXCEL_FILE_PATH', r'/home/ubuntu/invoice-processor vs/Unmapped report for Mapping.xlsx')
        ...
        if not matching_row_indices:
            ...
            try:
                ...
                if matching_row_indices:
                    ...
                    print(f"   ⚠️  No row found matching Hotel Name + Guest Name + Check-In Date + Check-Out Date")
            except Exception as e:
