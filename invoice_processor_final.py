...
2. Process invoices with OpenAI Vision
        ...
        for part in email_message.walk():
            if part.get_content_disposition() == 'attachment':
                ...
                attachment_info = {
                    ...
                    'size_bytes': size,
                    'payload': payload  # Include payload for OpenAI Vision
                }
...
def process_invoices():
    ...
    print("2. 🤖 Process invoices with OpenAI Vision")
    ...
    if openai_extractor.enabled:
        print("🤖 OpenAI Vision enabled for PDF analysis")
    else:
        print("⚠️  OpenAI Vision disabled - using text analysis only")
